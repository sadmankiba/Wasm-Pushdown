...
public class Sort {
	...
	public static void main(String[] args) {
		long t0 = System.nanoTime();
		String[] l = gen_array(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
		...
		for(int i = 0; i < 10; i++) {
			...
			l = gen_array(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
		...
		System.out.println((t1 - t0) * 1.0 / 1000000 + "," + (exec_sub / 10) * 1.0 / 1000000);
	}
}
